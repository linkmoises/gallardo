		...
		<div class="col-md-8 col-md-offset-2 col-xs-12">
			...
			<!-- End Tags -->
				...
				<div class="row post-top-meta">
					<div class="col-md-2">
						<a href="author.html"><img class="author-thumb" src="https://0.gravatar.com/avatar/f5b8708b8db2369736d0bbe660cbdd47?s=400&d=mm" alt="Moy"></a>
					</div>
					<div class="col-md-10">
						<a class="link-dark" href="author.html">Moy</a><a href="#" class="btn follow">Follow</a>
...
<div class="col-lg-4 col-md-6 mb-30px card-group">
    <div class="card h-100">
        <div class="maxthumb">
            <a href="#">
            <img class="img-fluid" src="http://via.placeholder.com/750x500" alt="Powerful things you can do with the Markdown editor">
            </a>
        </div>
        <div class="card-body">
            <h2 class="card-title">
                <a class="text-dark" href="#">We all wait for summer</a>
            </h2>
        </div>
        <!-- Begin Tags -->
			<div class="after-post-tags card-tags">
				<ul class="tags">
					<li><a href="#">Design</a></li>
					<li><a href="#">Growth Mindset</a></li>
					<li><a href="#">Productivity</a></li>
